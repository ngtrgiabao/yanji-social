...
const TermAndService = () => {
  useEffect(() => {
    document.title = "Terms and Services - Yanji Social";
  }, []);
  ...
  return (
    <div className="fs-4" style={{ padding: "8rem" }}>
      ...
      <p>
        These terms and services outline the rules and regulations for the use
        of Yanji Social's Website, located at https://yanji-social.vercel.app/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and services.
        Do not continue to use Yanji Social if you do not agree to take all of
      ...
      <p>
        We employ the use of cookies. By accessing Yanji Social, you agreed to
        use cookies in agreement with the Yanji Social's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Yanji Social and/or its licensors own the
        intellectual property rights for all material on Yanji Social. All
        intellectual property rights are reserved. You may access this from
        Yanji Social for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Yanji Social</li>
        <li>Sell, rent or sub-license material from Yanji Social</li>
        <li>Reproduce, duplicate or copy material from Yanji Social</li>
        <li>Redistribute content from Yanji Social</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Yanji
        Social does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Yanji Social,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, Yanji Social shall not be liable
      ...
      <p>
        Yanji Social reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Yanji Social a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Yanji Social; and (d) the link
      ...
      <p>
        ...
        e-mail to Yanji Social. Please include your name, your organization
      ...
      <p>
        No use of Yanji Social's logo or other artwork will be allowed for
